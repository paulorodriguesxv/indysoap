...
type
  ...
  Protected
    ...
    Function GetEncodingOptions : TIdSoapEncodingOptions; virtual;
...
begin
  ...
  GServer.EncodingType := GetClientEncodingType;
  GServer.EncodingOptions := GetEncodingOptions;
  GServer.Active := true;
  FixITI(GServer.ITI);
  ...
  if not GTestClient.Active then
    ...
    GTestClient.EncodingOptions := GetEncodingOptions;
    end;
...
begin
  ...
  try
    ...
    LRaw1.XML.AppendChild('test2', '').TextContentA := 'test-';
    ...
    check(LRaw1.XML.FirstChild.NextSibling.TextContentA = 'test-');
...
function TIdSoapInterfaceBaseTests.GetEncodingOptions: TIdSoapEncodingOptions;
begin
  result := DEFAULT_RPC_OPTIONS;
end;

function TIdSoapInterfaceDocLitTests.GetEncodingOptions: TIdSoapEncodingOptions;
begin

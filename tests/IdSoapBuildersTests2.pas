...
type
  ...
  public
    constructor Create(ATest: ITest; AName: String; AURL : String; ATypes : boolean; AGroupBURL : string = '');
  end;
...
constructor TIdSoapBuilders2Setup.Create(ATest: ITest; AName: String; AURL: String; ATypes : boolean; AGroupBURL : string);
begin

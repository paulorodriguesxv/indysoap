...
begin
  ...
  GServerExpectedHeaderNS := 'urn:test';
  GServerExpectedHeaderContent := 'content';
  FClient.SendHeaders.DefineSimpleHeader(GServerExpectedHeaderNS, GServerExpectedHeader, GServerExpectedHeaderContent).MustSend := true;
  Check(FIntf.Test1(1,2) = 3);
  ExpectedException := EIdSoapHeaderException;
  Check(FIntf.Test1(1,2) = 3);
end;
...
begin
  ...
  GServerExpectedHeaderNS := 'urn:test';
  GServerExpectedHeaderContent := '';
  FClient.SendHeaders.DefineSimpleHeader(GServerExpectedHeaderNS, GServerExpectedHeader, '').MustSend := true;
  Check(FIntf.Test1(1,2) = 3);
...
begin
  ...
  GServerExpectSession := false;
  Check(FIntf1.Test1(1,2) = 3);
  FServer.ITI.FindInterfaceByName('IRenamingTest').FindMethodByName('Test1', ntPascal).Session := ssoSessionRequired;

...
{==============================================================================
   OpenXML Exceptions
   DOMException EDOMParseError
 ==============================================================================}
{$IFDEF UNICODE}
  else if AnsiSameText(AExceptionClassName, 'DOMException') then
    begin
    result := DOMException.create(AMessage)
    end
  else if AnsiSameText(AExceptionClassName, 'EDOMParseError') then
    begin
    result := DOMException.create(AMessage)
    end
{$ELSE}
